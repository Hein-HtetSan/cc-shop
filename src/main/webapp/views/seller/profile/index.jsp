						...
						<div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group text-center">
                                    Name<h6 class="fw-semibold mb-3">${seller.name}</h6>
                                    Email<h6 class="fw-semibold mb-3">${seller.email}</h6>
                                    Phone<h6 class="fw-semibold">${seller.phone}</h6>
                                    Address<h6 class="fw-semibold">${seller.address}</h6>
                                    company<h6 class="fw-semibold">${seller.company}</h6>
                                    Business<h6 class="fw-semibold">${seller.bname}</h6>
                                </div>

                                <!-- #### Button group ####  -->
                                <div class="form-group text-center">
                                    <div class="d-flex">
                                        <a class="btn btn-primary w-100" href="${pageContext.request.contextPath}/SellerController?page=editSeller&seller_id=${seller.id}"> <i class="las la-pen"></i> Edit </a>
                                        <div class="mx-1"></div>
                                        <a href="${pageContext.request.contextPath}/LoginController?page=sellerLogout" class="btn btn-danger w-100"> <i class="las la-power-off"></i> Logout </a>
                                    </div>
                                    <hr>
                                    <a href="${pageContext.request.contextPath}/PasswordController?page=sellerPasswordChange&seller_id=${seller.id}" class="btn btn-link">Change Password?</a> | <a href="" class="btn btn-link btn-danger">Forget Password?</a> 
                                    <a class="btn btn-link  d-block " href="${pageContext.request.contextPath}/SellerController?page=dashboard" >  Back to Dashboard </a> 
                                </div>
                            </div>
                        </div>
