				...
				<div class="card shadow rounded">
					...
					<div class="card-body">
						<form action="${pageContext.request.contextPath}/PasswordController" method="post" class="">
							<input type="hidden" name="action" value="updateSellerPassword">
							...
							<div class="form-group">
								<a href="${pageContext.request.contextPath}/SellerController?page=profile&seller_id=${seller.id}" class="btn btn-secondary"><i class="las la-arrow-left"></i> Back</a>
