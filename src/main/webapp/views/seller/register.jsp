      ...
      <div class="col-md-7">
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="text-center fw-bold text-danger">REGISTER HERE</h3>
            <span class="text-center text-primary">Collaborate with us to expand your business.</span>
          </div>
          <hr>
          <div class="card-body">
            <form action="${pageContext.request.contextPath}/RegisterController?page=sellerRegister" method="post" class="d-flex align-items-center justify-content-center flex-column">
              ...
              <div class="form-group">
                ...
                <select name="business" class="form-control">
                	<option value="" selected>Choose business</option>
              ...
              <div class="d-flex align-items-center justify-content-between">
              	<div class="form-group">
	                ...
	                <input type="password" class="form-control" name="password" style="width: 100% !important;">
	              </div>
	              <div class="form-group">
	                <label for="" class="form-label">Confirm Password</label>
	                <input type="password" class="form-control" name="cpassword" style="width: 100% !important;">
	              </div>
              </div>
              <div class="form-group">
