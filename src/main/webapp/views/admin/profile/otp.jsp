      ...
      <div class="col-md-7">
        <div class="card">
          <div class="card-body" style="padding-top: 10rem;">
            <form action="${pageContext.request.contextPath}/OTPController?page=adminCheckOTP" method="post">
              ...
              <div class="form-group">
				...
				<div class="form-group" style="display: flex; align-items: center; justify-content: space-between; width: 300px;">
				    ...
				    <a href="${pageContext.request.contextPath}/OTPController?action=resendAdminOTP&email=${email}" class="btn btn-warning" id="resend-otp">Resend OTP</a>
				</div>
            </form>
            <hr>
              <a href="${pageContext.request.contextPath}/views/admin/profile/forgotPassword.jsp" class="btn btn-link " style="display: block; text-align: center;">Back</a>
          </div>
        </div>
      </div>
    </div>
