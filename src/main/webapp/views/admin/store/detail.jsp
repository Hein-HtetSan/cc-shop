			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">  Store - ${seller.company}</h4>
	                        ...
	                        <div class="col-12 col-md-5 offset-md-3">
	                            	<div class="card shadow">
	                            		<div class="card-header">
	                            			<h6 class="text-center fw-semibold"> Store Detail</h6>
	                            		</div>
	                            		<div class="card-body text-center">
	                            			...
	                            			<div class="row">
	                            				<div class="col-12 text-center">
	                            					Owner : <h6 style="margin-bottom: 15px;">${seller.name}</h6>
	                            			...
	                            			<a href="${pageContext.request.contextPath}/AdminController?page=store" class="btn btn-primary text-light">Ok</a>
                            			</div> 
                            	</div>
                            </div>
                        </div>
