...
<head>
	...
	<title>CC Dashboard | Order Detail</title>
	...
	<div class="wrapper ">
        ...
        <div class="row d-flex align-items-center justify-content-center mt-5" style="margin-top: 3rem;">
			...
			<div class="col-md-6 flex-column d-flex align-items-center justify-content-center mt-4">
				...
				<a class="btn btn-primary " href="${pageContext.request.contextPath}/AdminController?page=dashboard&filter_value=all">Understand</a>
			</div>
