														...
														<tr>
															...
															<td class="td-actions">
																<div class="form-button-action">
																	<a href="${pageContext.request.contextPath}/AdminController?action=userDetail&user_id=${user.id}">
																	<button type="button" data-toggle="tooltip" title="See Detail" class="btn btn-link btn-simple-primary">
																		<i class="las la-eye"></i>
																	</button>
																	</a>
																	<a href="${pageContext.request.contextPath}/AdminController?action=deleteUser&user_id=${user.id}">
